...
export const TOP_MEAL_INGREDIENT_PLANS: MealIngredientPlan[] = [
  ...
  {
    mealVariantId: "7-V-salatas",
    displayName: "Salátás cottage cheese–sonka tál",
    slot: "Vacsora",
    rank: 3,
    ...
    workout: [
      {
        ...
        amount: 200,
        unit: "g",
        kitchenAmount: "kb. 1 kisebb doboz",
        note: "Edzésnapos fő fehérjebázis, kupacokban a saláta tetejére kanalazva.",
      },
      {
        name: "Csirkemellsonka",
        amount: 60,
        unit: "g",
        kitchenAmount: "kb. 3–4 vékony szelet csíkokra vágva",
        note: "Plusz sovány fehérjeforrás a cottage cheese mellé.",
      },
      {
        name: "Jégsaláta vagy rukkola",
        amount: 70,
        unit: "g",
        kitchenAmount: "kb. 2 nagy marék",
        note: "A salátatál zöld alapja, nagy térfogat kevés kalóriával.",
      },
      {
        name: "Paradicsom",
        amount: 55,
        unit: "g",
        kitchenAmount: "kb. 1 kisebb paradicsom fele",
        note: "Lédús, friss zöldségelem.",
      },
      {
        name: "Uborka",
        amount: 55,
        unit: "g",
        kitchenAmount: "kb. 1/4 kígyóuborka",
        note: "Ropogós, alacsony kalóriás zöldségelem.",
      },
      {
        name: "Paprika",
        amount: 35,
        unit: "g",
        kitchenAmount: "kb. 1/3 kisebb paprika",
        note: "Édesebb, ropogós zöldségelem.",
      },
      {
        name: "Retek",
        amount: 20,
        unit: "g",
        kitchenAmount: "kb. 2 kisebb retek",
        note: "Enyhén csípős, ropogós zöldségelem.",
      },
      {
        name: "Olívaolaj",
        amount: 9,
        unit: "g",
        kitchenAmount: "kb. 1 evőkanál",
        note: "Edzésnapos középérték a 8–10 g-os tartományból, citromos öntethez.",
      },
      {
        name: "Citromlé, só, bors",
        amount: 1,
        unit: "adag",
        kitchenAmount: "ízlés szerint",
        note: "Könnyű salátaöntet az olívaolaj mellé.",
      },
      {
        name: "Teljes kiőrlésű kenyér",
        amount: 32.5,
    ...
    rest: [
      {
        ...
        amount: 185,
        unit: "g",
        kitchenAmount: "kb. 3/4–1 kisebb doboz",
        note: "Pihenőnapos középérték a 180–190 g-os tartományból, továbbra is erős fehérjebázis.",
      },
      {
        name: "Csirkemellsonka",
        amount: 50,
        unit: "g",
        kitchenAmount: "kb. 2–3 vékony szelet csíkokra vágva",
        note: "Csökkentett, de továbbra is hasznos sovány fehérjeforrás.",
      },
      {
        name: "Jégsaláta vagy rukkola",
        amount: 75,
        unit: "g",
        kitchenAmount: "kb. 2 nagy marék",
        note: "Pihenőnapon is nagy térfogatú salátaalap.",
      },
      {
        name: "Paradicsom",
        amount: 60,
      ...
      },
      {
        ...
        amount: 60,
        unit: "g",
        kitchenAmount: "kb. 1/4–1/3 kígyóuborka",
        note: "Pihenőnapon is bőséges, alacsony kalóriás zöldség.",
      },
      {
        name: "Paprika",
        amount: 30,
        unit: "g",
        kitchenAmount: "kb. 1/4–1/3 kisebb paprika",
        note: "Ropogós zöldségelem.",
      },
      {
        name: "Retek",
        amount: 20,
      ...
      },
      {
        ...
        unit: "g",
        kitchenAmount: "kb. 1 teáskanál",
        note: "Pihenőnapos maximum 1 teáskanálnyi olívaolaj a citromos öntethez.",
      },
      {
        name: "Citromlé, só, bors",
        amount: 1,
      ...
      },
      {
        ...
        amount: 1,
        unit: "adag",
        kitchenAmount: "max. 1/2 szelet kenyér, kb. 20 g, vagy abonett/puffasztott szelet",
        note: "Pihenőnapon csökkentett esti szénhidrátforrás.",
      },
    ],
    ...
    audit: {
      status: "PASS",
      notes: [
        "Az edzésnapos adag erős fehérjebázist ad cottage cheese és csirkemellsonka kombinációjával.",
        "A pihenőnapi adag kissé csökkenti a cottage cheese-t, a sonkát, az olívaolajat és a kenyér jellegű köretet.",
        "Pihenőnapon a salátamennyiség magasabb, ami jól megtartja az étel térfogatát alacsonyabb kalória mellett.",
        "A vegyes saláta külön bontása praktikusabbá teszi a hozzávaló-adag nézetet, mint egyetlen vegyes saláta sor.",
        "Ez a vacsora hideg, salátás, magas fehérjetartalmú esti opcióként jól működik.",
      ],
      optionalSuggestion:
        "Ha pihenőnapon még alacsonyabb szénhidrát a cél, a kenyér vagy abonett/puffasztott szelet elhagyható, de ezt külön döntésként érdemes kezelni, nem az alap verzió részeként.",
    },
  ...
  {
    mealVariantId: "1-V-stirfry",
    displayName: "Csíkokra vágott stir-fry",
    slot: "Vacsora",
    rank: 4,

    workout: [
      {
        name: "Csirkemell csíkok",
        amount: 165,
        unit: "g",
        kitchenAmount: "kb. 1 közepes-nagyobb csirkemellfilé csíkokra vágva",
        note: "Edzésnapos fő fehérjebázis, wokban vagy serpenyőben pirítva.",
      },
      {
        name: "Brokkoli",
        amount: 135,
        unit: "g",
        kitchenAmount: "kb. 2–3 nagyobb marék brokkolirózsa",
        note: "Edzésnapos zöldségalap a stir-fry-ban.",
      },
      {
        name: "Sárgarépa",
        amount: 70,
        unit: "g",
        kitchenAmount: "kb. 1 kisebb-közepes répa csíkokra vágva",
        note: "Ropogósabb, édesebb zöldségelem.",
      },
      {
        name: "Paprika",
        ...
        unit: "g",
        kitchenAmount: "kb. 1/2 kisebb paprika csíkokra vágva",
        note: "Az extra zöldség része, színt és ropogósságot ad.",
      },
      {
        name: "Cukkini",
        amount: 50,
        unit: "g",
        kitchenAmount: "kb. 1/5–1/4 közepes cukkini csíkokra vágva",
        note: "Könnyű extra zöldség, jól működik wokos ételben.",
      },
      {
        name: "Olaj",
        amount: 1,
        unit: "tk",
        kitchenAmount: "1 teáskanál",
        note: "Sütéshez használt zsiradék.",
      },
      {
        name: "Szójaszósz",
        amount: 1,
        unit: "adag",
        kitchenAmount: "ízlés szerint",
        note: "Ízesítéshez, sósság miatt óvatosan adagolva.",
      },
    ],
    ...
    rest: [
      {
        ...
        amount: 145,
        unit: "g",
        kitchenAmount: "kb. 1 közepes csirkemellfilé adag csíkokra vágva",
        note: "Pihenőnapon kissé csökkentett, de erős fehérjebázis.",
      },
      {
        name: "Brokkoli",
        ...
        unit: "g",
        kitchenAmount: "kb. 3 nagyobb marék brokkolirózsa",
        note: "Pihenőnapon emelt zöldségmennyiség a teltségérzethez.",
      },
      {
        name: "Sárgarépa",
        amount: 80,
        unit: "g",
        kitchenAmount: "kb. 1 közepes répa csíkokra vágva",
        note: "Pihenőnapon kissé magasabb zöldségmennyiség.",
      },
      {
        name: "Paprika",
        amount: 60,
        unit: "g",
        kitchenAmount: "kb. 1/2 kisebb-közepes paprika csíkokra vágva",
        note: "Extra zöldség, kenyér/rizs nélküli vacsorához jól növeli a térfogatot.",
      },
      {
        name: "Cukkini",
        amount: 60,
        unit: "g",
        kitchenAmount: "kb. 1/4 közepes cukkini csíkokra vágva",
        note: "Könnyű, alacsony kalóriás extra zöldség.",
      },
      {
        name: "Olaj",
        amount: 1,
        unit: "tk",
        kitchenAmount: "1 teáskanál",
        note: "Pihenőnapon is marad a minimális sütési zsiradék.",
      },
      {
        name: "Szójaszósz",
        amount: 1,
        unit: "adag",
        kitchenAmount: "ízlés szerint",
        note: "Ízesítéshez, kenyér/rizs nélküli stir-fry-hoz is használható.",
      },
    ],
    ...
    audit: {
      status: "PASS",
      notes: [
        "Az edzésnapos adag erős csirkemell-fehérjebázisra épül, mérsékelt zöldséggel és minimális olajjal.",
        "A pihenőnapi adag csökkenti a csirkemell mennyiségét, miközben növeli a brokkolit, répát és extra zöldségeket.",
        "A pihenőnapi verzió kenyér és rizs nélkül szerepel, ezért a nagyobb zöldségmennyiség jó döntés a teltségérzethez.",
        "Az olaj mindkét napon 1 teáskanál marad, így a zsiradék kontrollált.",
        "A paprika és cukkini külön bontása praktikusabbá teszi a hozzávaló-adag nézetet, mint egyetlen extra zöldség sor.",
      ],
      optionalSuggestion:
